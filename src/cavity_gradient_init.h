...
#ifndef __CAVITY_GRADIENT_INIT_H__
#define __CAVITY_GRADIENT_INIT_H__
...
void cavity_gradient_initialise_marginal (cavity_gradient_workspace *);
void cavity_gradient_workspace_initialise (cavity_gradient_workspace *);
